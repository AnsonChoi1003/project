# -*- coding: utf-8 -*-
"""20864751_Choi Kin Ho_Worked Project_CHEM4160.ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/1b49wuLEyXcTSUlscDl_LGHLJCKfLLQy_

#Worked Project
#CHEM4160 Cheminformatics
#Wine Quality Analysis and Modeling
#Choi Kin Ho 20864751


---

Hello Professor. In this worked project, I made a lot of different of analysis, machine learning techniques, predictive model, etc. and also a catalyst chemical reaction at the end.They are all made in every independent big cell part which are all well-organized with each step of the workflow presented clearly and logically. In addition, a brief justification of my decisions accompany each step. I provide a brief discussion of your results and propose some predictions at the end of each big cell part. I added text cells to explain and explore my ideas instead of in-line comments that hope you will not be dazzled and can make the structure more clean and easy to look. Moreover, I also made some comparisons to produce a better result. Every big cell part with appropriate choices of libraries or functions. Therefore, even you copy any part of them, you can run it with a completed structure. Hope you enjoy my project which come through hard work. Thank you for your patient and time!


---

#The relationships between the features and the quality of the wine.
#Basic descriptive statistics, Correlation Matrix, Scatter Plots, Box Plot
